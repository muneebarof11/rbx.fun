<template>
    <div class="modal fade" id="basicChestModal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
                ...
                $api.postData('open-chest', FORM_DATA)
                    .then((response) => {
                        if(response > 0) {
                            ...
                            $helper.saveLocalData('basic-chest', 1);
                        } else {
                            Swal.fire(
                                'Oops!',
